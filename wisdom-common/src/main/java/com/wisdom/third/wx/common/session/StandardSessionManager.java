...
import com.wisdom.third.wx.common.util.res.StringManager;
...
public class StandardSessionManager implements WxSessionManager, InternalSessionManager {
  ...
  public void processExpires() {
    ...
    if(log.isDebugEnabled())
      log.debug("Start expire sessions {} at {} sessioncount {}");
    ...
    if(log.isDebugEnabled())
      log.debug("End expire sessions {} processingTime {} expired sessions: {}");
