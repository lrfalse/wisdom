...
import com.wisdom.third.wx.common.session.WxSession;
...
import com.wisdom.third.wx.cp.util.json.WxCpGsonBuilder;
...
public class WxCpServiceImpl implements WxCpService {
  ...
  public String[] oauth2getOpenId(String code) throws WxErrorException {
	String url = "https://qyapi.weixin.qq.com/cgi-bin/user/getuserinfo?"
	   + "code=" + code;
	String responseText = get(url, null);
	JsonElement je = Streams.parse(new JsonReader(new StringReader(responseText)));
	JsonObject jo = je.getAsJsonObject();
	return new String[] {GsonHelper.getString(jo, "OpenId"), GsonHelper.getString(jo, "DeviceId"),GsonHelper.getString(jo, "UserId")};
  }
  ...
  public String convertToOpenid(String userId) throws WxErrorException {
	  ...
	  JsonObject jsonObject = new JsonObject();
	  jsonObject.addProperty("userid", userId);
	  String responseText = post(url, jsonObject.toString());
	  JsonElement je = Streams.parse(new JsonReader(new StringReader(responseText)));
	  JsonObject jo = je.getAsJsonObject();
	  return GsonHelper.getString(jo, "openid");
  }
  
  public String convertToUserid(String openId) throws WxErrorException {
